<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegistroProveedor.aspx.cs" Inherits="Proyecto_Final_Aplicada2.Registros.RegistroProveedor" %>
					...
					<div class="card-body">
						...
						<asp:Panel ID="formRegistro" runat="server">							
							...
							<div class="form-group">
								...
								<div class="form-group">
								<label for="textboxEmail">Direccion
								</label>
