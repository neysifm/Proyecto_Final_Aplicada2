<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegistroEmpleado.aspx.cs" Inherits="Proyecto_Final_Aplicada2.Registros.RegistroEmpleado" %>
					...
					<div class="card-body">
						...
						<asp:Panel ID="formRegistro" runat="server">							
							...
							<div class="form-group">
								...
								<asp:TextBox runat="server" type="text" ID="textboxTelefono" class="form-control" placeholder="Telefono" required />
							</div>

							<div class="form-group">
								<label for="textboxDepartamento">Departamento</label>
								<asp:TextBox runat="server" type="text" ID="textboxDepartamento" class="form-control" placeholder="Departamento" required />
							</div>

							<div class="form-group">
								<label for="textboxCargo">Cargo
								</label>
								<asp:TextBox runat="server" type="text" ID="textboxCargo" class="form-control" placeholder="Cargo" required />
							</div>
